...
\begin{document}
	...
	{\setstretch{.8}
		...
		\begin{abstract}
			...
			Our two-person team consists of Tao Xu (si19010) and Yinan Yang (ff19085). Due to the impact of Covid19, we collaboarated remotely via GitHub to co-develop this project.
